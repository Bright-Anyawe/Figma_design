      ...
      <section className="heroScreenContainer">
        <div className="heroScreen">
          <div className="cardCarousel">
            <img src="public/Figma Img/Logo/parap rose.png" alt="parap rose" />
           <img src="public/Figma Img/Logo/parap teal.png" alt="parap teal" />
            <img src="public/Figma Img/Logo/parap black.png" alt="" />
           <img src="public/Figma Img/Logo/parap msb.png" alt="parap msb" />
         <img src="public/Figma Img/Logo/parap gray.png" alt="parap gray" />
