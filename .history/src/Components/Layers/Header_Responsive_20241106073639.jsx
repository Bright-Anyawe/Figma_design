...
if (backgroundColor) {
  ...
  appPresentationHeaderText.current.classList.add("appPresentationHeaderText");
  appPresentationTextColor.current.classList.add("appPresentationTextColor");
  ...
  appPresentationHeaderText.current.classList.remove("appPresentationHeaderText");
  appPresentationTextColor.current.classList.aremovedd("appPresentationTextColor");
  cashBackHeadTitle.current.classList.add("cashBackHeadTitle");
  cardsColor.current.classList.add("cardsColor");
  brandsTextTitleColor.current.classList.add("brandsTextTitleColor");
  downloadTitleColor.current.classList.add("downloadTitleColor");
