      ...
      <section className="brandsContainer" data-testid="brand-contents">
        <div className="brands">
            ...
            <div className="brandImgContainer">
              <div className="brandsImages">
                <div className="brandsFirstImgContainer">
                  <img src="/Yemeksepeti.png" alt="yemekSepetiImg" />
                  <img src="/Uber.png" alt="uberImg" />
                </div>
                <div className="brandsSecondImgContainer">
                  <img src="/Bitaksi.png" alt="Bitaksi" />
                  <img src="/Binance.png" alt="binanceImg" />
                  <img src="/Yandex.png" alt="yandexImg" />
                </div>
              </div>
            </div>
            <p
              className="brandTextPara"
          ...
          <div className="brandsImages desktop">
            <div className="brandsFirstImgContainer">
              <img src="public/Yemeksepeti.png" alt="yemekSepetiImg" />
