    ...
    <>
      <section className="cashBackContainer">
          ...
          <div className="cardsContainer">
            ...
            <div className="card food">
              ...
              <h4 className="foodHeadText">
                Earn <span className="foodHeadTextDesign">10%</span> instant cashback
              </h4>
              <p>
        ...
        <div className="cashBackIndicator">
          ...
          <div className="indicatorCircle 1"></div>
          <div className="indicatorCircle 2"></div>
          <div className="indicatorCircle 3"></div>
          <div className="indicatorCircle 4"></div>
          <div className="indicatorCircle 5"></div>
          <div className="indicatorCircle 6"></div>
          <div className="indicatorCircle 7"></div>
          <div className="indicatorCircle 8"></div>
