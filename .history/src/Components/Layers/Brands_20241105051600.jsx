    ...
    <>
      <section className="brandsContainer">
        <div className="brands">
          ...
          <div>
            <div>
              <img src="public/Figma Img/Logo/Yemeksepeti.png" alt="yemekSepetiImg" />
              <img src="public/Figma Img/Logo/Rectangle 29.png" alt="uberImg" />
            </div>
            <div>
              <img src="" alt="" />
              <img src="" alt="binanceImg" />
              <img src="" alt="yandexImg" />
            </div>
          </div>
        </div>
      </section>
