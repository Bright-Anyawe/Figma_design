    ...
    <>
      <section className="appPresentationContainer">
        <div className="appPresentation">
          <div className="appPresentationSubTitle">
            <h3>Enjoy your financial freedom with a single app.</h3>

            <p className="subText">
              All you need is <span className="appTextDesign">Parap</span>
            </p>
          </div>
          <div className="appPresentationContents">
            <div className="accountLeftContents">
              ...
              <div className="earnCashBackFill">
                ...
                <img src="public/Figma Img/Logo/Cashback Fill.png" alt="earnCashBackImage" />
              </div>
            </div>
            ...
            <div className="accountRightContents">
              <img src="public/Figma Img/Logo/Save money circle.png" alt="saveImage" />
              ...
              <div className="requestMoneyContainer">
                <img src="public/Figma Img/Logo/Save money circle.png" alt="requestImage" />
              ...
              <div className="qRCode">
                <img src="public/Figma Img/Logo/Request circle.png" alt="qRCodeImage" />
