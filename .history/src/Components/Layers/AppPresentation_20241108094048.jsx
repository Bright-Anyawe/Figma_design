      ...
      >
        <div className="appPresentation">
          <div
            ...
            style={{ color: isBlack ? "#FFFFFF66" : "black" }}
          >
          ...
          >
            <div className="iphoneContainer">
              <img className="leftVector" src="public/Vector 1.png" alt="" />
              <img
                className="iphoneImg"
                src="public/iPhone 14 Pro Space Black Mockup (2).png"
                alt="iPhone 14 Pro Space Black Mockup"
              />
              <img className="rightVector" src="public/Vector 1.png" alt="" />
            </div>

            <div className="appInfoSlider" ref={appInfoSliderColor}>
              <div
                className="accountLeftContents"
                ref={appInfoSliderColor}
                style={{ color: isBlack ? "#FFFFFF66" : "black" }}
              >
                <div className="accountContainer">
                  ...
                  >
                    ...
                    <h4 style={{ color: isBlack ? "#FFFFFF" : "black" }}>Open an account</h4>
                    <p>
              ...
              >
                ...
                <div className="qRCode">
                  <img src="public/QR circle.png" alt="qRCodeImage" />
