    ...
    <>
      <section className="cashBackContainer" data-testid="cashBack-contents">
        <div className="cashBack">
          ...
          <div className="cardsContainer" ref={cardsColor}>
            ...
            <div className="card streaming">
              <div className="streamingContainer">
                <img
                  src="public/Streaming card icon.png"
                  alt="musicImg"
                />
              </div>
              <div className="netFlixContainer">
                <img
                  src="public/image 56.png"
                  alt="spotifyImg"
                />
              </div>
            ...
            <div className="card groceries">
              <div className="groceriesContainer">
                <img
                  src="public/Groceries card icon.png"
                  alt="groceriesImg"
                />
              </div>
              <div className="carreFourContainer">
                <img
                  src="public/image 57.png"
                  alt="carreFourImg"
                />
              </div>
