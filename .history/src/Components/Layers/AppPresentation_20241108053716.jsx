          ...
          >
            <div className="iphoneContainer">
              <img
                ...
                src="public/Figma Img/Logo/Vector 1.png"
                alt=""
              />
              <img
                className="iphoneImg"
          ...
          >
            ...
            <div className="iphoneContainer">
              <img
                ...
                src="Figma Img/Logo/Vector 1.png"
                alt=""
              />
              <img
                className="iphoneImg"
                src="Figma Img/Logo/iPhone 14 Pro Space Black Mockup (2).png"
                alt="iPhone 14 Pro Space Black Mockup"
              />
              <img
            ...
            <div className="accountRightContents">
              <div className="saveMoneyContainer">
                <img
                  src="Figma Img/Logo/Save money circle.png"
                  alt="saveImage"
                />
              ...
              <div className="requestMoneyContainer">
                <img
                  src="Figma Img/Logo/Request circle.png"
                  alt="requestImage"
                />
