          ...
          <div className="cardsContainer">
            ...
            <div className="card streaming">
              <div className="streamingContainer">
                <img src="public/Figma Img/Logo/Streaming card icon.png" alt="musicImg" />
              </div>
              <div className="netFlixContainer">
                <img src="public/Figma Img/Logo/image 56.png" alt="spotifyImg" />
              </div>
            ...
            <div className="card groceries">
              <div className="groceriesContainer">
                <img src="" alt="groceriesImg" />
              </div>
              <div className="carreFourContainer">
                <img src="public/Figma Img/Logo/Groceries card icon.png" alt="carreFourImg" />
              </div>
            ...
            <div className="card food">
              <div className="foodContainer">
                <img src="" alt="foodImg" />
                <p className="foodText">Food & Beverages</p>
              </div>
              <div className="foodContainer">
                <img src="" alt="foodImg" />
              </div>
